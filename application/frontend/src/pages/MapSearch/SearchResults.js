  ...
  return (
    <>
      ...
      <div className={styles["page-navigation-container"]}>
        {currentPage != 1 && maxResultsPages != 1 && (
          <button className={styles["back-button"]} onClick={previousPage}>
            Prev Page
          </button>
        )}
        {currentPage < maxResultsPages && (
