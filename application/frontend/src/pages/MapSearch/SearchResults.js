...
function SearchResults({searchResultsDisplay, searchResults, currentPage, searchCategory, displayFilterOverlay, panTo, maxResultsPages, previousPage, nextPage}) {
    return (
        <>
            <div className={styles['search-results-container']} style={{display: searchResultsDisplay}}>
            <>
                <div className={styles['header-container']}>
                    <span><span className={styles['header']}>Results</span><button className={styles['filter-button']} onClick={displayFilterOverlay}>Filter</button></span>
