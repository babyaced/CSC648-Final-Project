    ...
    <Modal display={display} onClose={onClose}>
      <div className={styles["terms-and-conditions-container"]}>
        ...
        <p>
          ...
          use of Zoou's Website, located at zoou.app.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use zoou.app if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing zoou.app, you agreed to use
          cookies in agreement with the Zoou's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Zoou and/or its licensors own the
          intellectual property rights for all material on zoou.app. All
          intellectual property rights are reserved. You may access this from
          zoou.app for your own personal use subjected to restrictions set in
        ...
        <p>
          ...
          Zoou does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Zoou,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Zoou shall not be liable for
        ...
        <p>
          Zoou reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Zoou a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of Zoou; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to Zoou. Please include your name, your organization
        ...
        <p>
          No use of Zoou's logo or other artwork will be allowed for linking
