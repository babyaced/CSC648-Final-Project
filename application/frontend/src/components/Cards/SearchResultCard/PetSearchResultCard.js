...
function PetSearchResultCard({searchResult, panTo, index}) {
    return (
        <li className={styles['search-result']} onClick={() => {panTo({lat: parseFloat(searchResult.latitude), lng:parseFloat(searchResult.longitude)})}}>
...
export default PetSearchResultCard
